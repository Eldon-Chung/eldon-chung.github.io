...
![](/assets/diagrams/algos/intro-binary-search-setup.png){: style="width:100%; height:100%; background-color: white;"}
...
![](/assets/diagrams/algos/intro-binary-search-first-comparison.png){: style="width:100%; height:100%; background-color: white;"}
