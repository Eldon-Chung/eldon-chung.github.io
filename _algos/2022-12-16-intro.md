...
![](/assets/diagrams/algos/intro/concept.png){: style="width:100%; height:100%;"}
...
{% svg /assets/diagrams/algos/intro-binary-search-setup.svg width=24 foo="bar" %}{: style="background-color: white; width:100%; height:100%;"}
...
{% svg /assets/diagrams/algos/intro-binary-search-first-comparison.svg width=24 foo="bar" %}{: style="background-color: white; width:100%; height:100%;"}
...
All in all, the first three sections are starting to look like this:

{% svg '/assets/diagrams/algos/intro/roadmap.svg' width="100%" height=auto %}
Just a sketch of how the sections relate to each other.
{: style="color:gray; font-size: 80%; text-align: center;"}
