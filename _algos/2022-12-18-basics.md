...
**Key Takeaway:** Not all memory accesses are created equal. Subsequent accesses to adjacent memory locations
are typically faster than to locations that are spread out.
{: .notice}
