...
We'll start with the fixed-point system.
...
we can store any fractional value in the range of $$0$$ to $$0.875$$ --- basically we have a 
fixed precision of $$0.125$$.

**Fixed Point Values**: If we want to store fractional values up to a fixed precision, 
we can store them as a _fixed point_ value in the manner as described above.
{: .notice--success}
